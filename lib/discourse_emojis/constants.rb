...
module DiscourseEmojis
  ...
  EMOJI_ALIASES = {
    ...
    "kiss_woman_man" => %w[couplekiss couplekiss_man_woman],
    ...
    "côte_d_ivoire" => %w[cote_divoire cote_d_ivoire],
    "china" => %w[cn flag_cn],
    "curaçao" => ["curacao"],
    "czechia" => ["czech_republic"],
    "türkiye" => %w[turkiye tr flag_tr],
